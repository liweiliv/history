...
#include "../util/memlib/MempRing.h"
#include <string>
#include <string.h>
#include <pthread.h>
...
private:
    ...
    atomic_t m_index_count;
    int32_t m_index_start_pos;
    int32_t m_index_end_pos;
    int (*m_clear_extern_info_func)(void*);
...
private:
    ...
    int  load_index_file();
public:
    block_file_manager(const char * index_filename,int (*clear_extern_info_func)(void*) = NULL);
