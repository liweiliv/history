...
template<typename GT_TYPE>
bool IntersectTriangle(const g_pos_3d<GT_TYPE>& orig, const g_pos_3d<GT_TYPE>& dir,
		g_pos_3d<GT_TYPE>& v0, g_pos_3d<GT_TYPE>& v1, g_pos_3d<GT_TYPE>& v2,
...
template<typename GT_TYPE>
bool IsIntersectTriangle(const g_pos_3d<GT_TYPE>& orig, const g_pos_3d<GT_TYPE>& dir,
		const g_pos_3d<GT_TYPE>& v0, const g_pos_3d<GT_TYPE>& v1, const g_pos_3d<GT_TYPE>& v2)
{
    // E1
	D_SUB_3D_VECTOR_TEMPLATE(E1,v1,v0);
